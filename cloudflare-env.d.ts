/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv ./cloudflare-env.d.ts` (hash: 71e5590f090cbe3e6b3c378c12eb431f)
// Runtime types generated with workerd@1.20260911.1 2026-04-22 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	NEXT_INC_CACHE_R2_BUCKET: R2Bucket;
	ASSETS: Fetcher;
	NEXT_PUBLIC_GOOGLE_ANALYTICS_ID: "G-KJ3V3HYFYR";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_GOOGLE_ANALYTICS_ID" | "NEXTJS_ENV" | "NEXT_PUBLIC_GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET">> {}
}

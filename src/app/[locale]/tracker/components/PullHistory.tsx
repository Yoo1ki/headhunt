                      ...
                      {!hideBanner && (
                        <td>
                          <div className="flex justify-center items-center">
                            <div className="relative h-8 w-24 rounded-md overflow-hidden">
                              {banner ? (
                                <CFImage
                                  src={banner.image}
                                  alt={banner.name}
                                ...
                                <div className="bg-neutral-900/80 w-full h-full text-xs flex items-center justify-center rounded-md text-white/60">
                                  Unknown
                                </div>
                              )}
                            </div>
